...
alias tddb='./vendor/bin/codecept build'
alias tddr='./vendor/bin/codecept run'
alias tddu='./vendor/bin/codecept run unit'
alias tddf='./vendor/bin/codecept run functional'
alias tdda='./vendor/bin/codecept run acceptance'
